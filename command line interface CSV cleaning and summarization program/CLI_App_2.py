...
def get_summary_statistics(df):
    ...
    Enter the country name to get GDP per capita summary(type 'Done' to exit): """
                    ).title()
        ...
        if name == 'Done':
            return print("""
                         ...
                         Thank you for using the GDP Per Capita database app!
                         
                         
                         """)
    
        elif name not in dict(df['Country Name']).values():
